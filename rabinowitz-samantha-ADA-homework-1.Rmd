...
The following will split the string of characters in the vector called **quote** into individual words while also removing any punctuation contained in the vector
```{R}
library(stringr)
